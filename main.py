import pyshorteners
import re, sys, socket, random, time
...
def shortener_service(url):
    ...
    console.print("1. TinyURL\n2. DAGD\n3. Clck.ru", style="cyan")
    try:
        select = int(Prompt.ask("[bold green]Select (1-3)[/]", default="1"))
        ...
        if select == 1:
            ...
            console.print("[bold red]Invalid selection, please choose between 1-3.[/]")
            return "error"
    except ValueError:
        console.print("[bold red]Invalid input, please enter a number between 1-3.[/]")
        return "error"
